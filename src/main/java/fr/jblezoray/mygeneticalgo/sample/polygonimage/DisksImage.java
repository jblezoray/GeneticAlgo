...
public class DisksImage extends AbstractFitableImage {
   ...
   * @param height
   */
  public DisksImage(int width, int height) {
    this.width = width;
    this.height = height;
    this.bgColorRed = 0;
    this.bgColorGreen = 0;
   ...
   * @param copyMe
   */
  private DisksImage(DisksImage copyMe) {
  ...
  public void doDNACrossover(Random rand, DNAAbstract other, int minCrossovers,
    ...
    EasyListCrossover.<DiskShape>doCrossover(rand, minCrossovers, maxCrossovers,
        this.disks, ((DisksImage)other).disks, out1, out2);
    this.disks = out1;
    ((DisksImage)other).disks = out2;
    
    this.notifyImageUpdated();
    ((DisksImage)other).notifyImageUpdated();
  }

  @SuppressWarnings("unchecked")
  @Override
  public DisksImage copy() {
    return new DisksImage(this);
  }
