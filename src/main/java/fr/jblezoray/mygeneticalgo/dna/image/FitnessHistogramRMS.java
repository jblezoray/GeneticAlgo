 ...
 *
 */
public class FitnessHistogramRMS<X extends AbstractImageDNA> 
implements IFitness<X> {
  
  private final BufferedImage image;
  
  public FitnessHistogramRMS(AbstractImageDNA reference) {
  ...
  public double computeFitnessOf(X candidateToEvaluate) {
    ...
    double a = sumSquaredValues / (this.image.getWidth() * this.image.getHeight());
